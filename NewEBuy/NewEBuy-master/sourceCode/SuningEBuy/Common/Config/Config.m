...
-(id) init {
    ...
    [self.defaults registerDefaults:[NSDictionary dictionaryWithObjectsAndKeys:
                                     ...
                                     @"",                                    dServerURL,
                                     [NSArray array],           dTopBannerList,
                                     [NSArray array],           dTopAdList,
                                     [NSArray array],           dTopBookAdList,
                                     [NSArray array],           dTopSearchAdList,
                                     [NSArray array],           dSpecialSubjectList,
                                     [NSArray array],           dm2DaJuHuiList,
                                     [NSArray array],           dActList,
                                     [NSArray array],           dCenterBannerList,
...
//                                     @"9017",                                 dDefaultCity,
                                     ...
                                     @"",                                     dDefaultAddressId,
                                     [NSMutableArray array],            dLoginShoppingCartArr,
                                     [NSMutableArray array],            dUnloginShoppingCartArr,
                                     [NSArray array],            dEfubaoInfoList,
                                     ...
                                     [NSMutableArray array],     dGetCodeList,
                                     [NSMutableArray array],     dPayServiceList,
                                     [NSMutableArray array],     dPayWaterList,
                                     [NSMutableArray array],     dPayElectricList,
                                     [NSMutableArray array],     dpayGasList,
                                     [NSMutableArray array],     dPhoneNumData,
                                     @"",                                     dProductTotalPrice,
                                     @"",
                                         dHelperVersion,
                                     ...
                                     @"",
                                     dPushMessageId,
                                     [NSMutableArray array],     dLotteryCatArray,
                                     [NSMutableArray array],     dAllLotteryArray,
                                     [NSMutableArray array],     dGbHistoryArray,
                                     @"",
                                     dGbDefaultCityId,
                                     @"",
                                     dGbDefaultCityName,
                                     ...
                                     @"南京市",                             dLocationCity,
                                     @"0",    dIsRegist,
                                     [NSMutableArray array],     dAdvInfoList,
                                     @"南京市",                                dNearByCityName,
                                     @"9173",                                 dNearByCityId,
