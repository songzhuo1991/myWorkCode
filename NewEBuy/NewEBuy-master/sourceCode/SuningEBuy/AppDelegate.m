...
- (void)checkVersionUpdate
{
    ...
    if (![CheckUpdateCommand autoChecked])
    {
        ...
        [CommandManage excuteCommand:command completeBlock:^(id<CommandDateSource> cmd) {
...
//            [weakSelf checkVersionUpdate];
            ...
            [CommandManage excuteCommand:cmd_ completeBlock:^(id<CommandDateSource> cmd) {
